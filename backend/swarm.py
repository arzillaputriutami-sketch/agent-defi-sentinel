"""DeFi Sentinel Swarm multi-agent reasoning core.
...
PROJECT_NAME = 'DeFi Sentinel Swarm'
DOMAIN = 'DeFi risk intelligence'
AUDIENCE = 'protocol risk teams and treasury operators'
AGENT_ROLES = ['Liquidity Sentinel', 'Oracle Divergence Analyst', 'Bridge Exposure Mapper', 'Liquidation Cascade Forecaster', 'Treasury Action Planner']
SIGNALS = ['pool_depth_change', 'oracle_spread_bps', 'bridge_outflow_usd', 'liquidation_queue_usd', 'governance_delay_hours']
SCENARIOS = ['stablecoin depeg pressure', 'DEX pool depth collapse', 'oracle feed divergence']
